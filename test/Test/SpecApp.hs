...
spec =
  describe "Process" $ do
    it "[applyConfig]" $ do
      ...
      result <- applyConfig config parsed
      T.writeFile "./aaa.rtf" $ views _1 render result
      result
        `shouldBe` ( RTFDoc
                      { rtfDocHeader =
                          RTFHeader
                      ...
                      , rtfDocContent = [
                        ContentGroup 
                          [ContentControlWord NoPrefix "info" NoSuffix, ContentGroup [ContentControlWord NoPrefix "author" SpaceSuffix, ContentText "Yui Nishizawa"]], ContentControlWord NoPrefix "pard" NoSuffix, ContentControlWord NoPrefix "pardeftab" (RTFControlParam 720), ContentControlWord NoPrefix "partightenfactor" (RTFControlParam 0), ContentControlWord NoPrefix "f" (RTFControlParam 0), ContentControlWord NoPrefix "fs" (RTFControlParam 28), ContentText " ", ContentControlWord NoPrefix "cf" (RTFControlParam 2), ContentText " ", ContentControlWord NoPrefix "cb" (RTFControlParam 3), ContentText " ", ContentControlWord NoPrefix "expnd" (RTFControlParam 0), ContentControlWord NoPrefix "expndtw" (RTFControlParam 0), ContentControlWord NoPrefix "kerning" (RTFControlParam 0), ContentText "This is b test", ContentControlSymbol '\n', ContentControlSymbol '\n', ContentText "Normbl text", ContentControlSymbol '\n', ContentControlSymbol '\n', ContentControlWord NoPrefix "pard" NoSuffix, ContentControlWord NoPrefix "tx" (RTFControlParam 566), ContentControlWord NoPrefix "tx" (RTFControlParam 1133), ContentControlWord NoPrefix "tx" (RTFControlParam 1700), ContentControlWord NoPrefix "tx" (RTFControlParam 2267), ContentControlWord NoPrefix "tx" (RTFControlParam 2834), ContentControlWord NoPrefix "tx" (RTFControlParam 3401), ContentControlWord NoPrefix "tx" (RTFControlParam 3968), ContentControlWord NoPrefix "tx" (RTFControlParam 4535), ContentControlWord NoPrefix "tx" (RTFControlParam 5102), ContentControlWord NoPrefix "tx" (RTFControlParam 5669), ContentControlWord NoPrefix "tx" (RTFControlParam 6236), ContentControlWord NoPrefix "tx" (RTFControlParam 6803), ContentControlWord NoPrefix "slleading" (RTFControlParam 24), ContentControlWord NoPrefix "pardirnatural" NoSuffix, ContentControlWord NoPrefix "partightenfactor" (RTFControlParam 0), ContentControlWord NoPrefix "f" (RTFControlParam 1), ContentText " ", ContentControlWord NoPrefix "cf" (RTFControlParam 2), ContentText " ", ContentControlWord NoPrefix "cb" (RTFControlParam 4), ContentText " ", ContentControlSymbol '\n', ContentText "Code block", ContentControlSymbol '\n', ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 0), ContentText " ", ContentControlWord NoPrefix "cf" (RTFControlParam 0), ContentText " ", ContentControlWord NoPrefix "cb" (RTFControlParam 1), ContentText " ", ContentControlWord NoPrefix "kerning" (RTFControlParam 1), ContentControlWord NoPrefix "expnd" (RTFControlParam 0), ContentControlWord NoPrefix "expndtw" (RTFControlParam 0), ContentText " ", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 2), ContentControlWord NoPrefix "b" SpaceSuffix, ContentText "Bold text\n", ContentControlWord NoPrefix "f" (RTFControlParam 0), ContentControlWord NoPrefix "b" (RTFControlParam 0), ContentText " ", ContentControlSymbol '\n', ContentControlWord NoPrefix "ul" SpaceSuffix, ContentText "Underline text", ContentControlSymbol '\n', ContentControlWord NoPrefix "ulnone" SpaceSuffix, ContentControlWord NoPrefix "strike" SpaceSuffix, ContentControlWord NoPrefix "strikec" (RTFControlParam 0), ContentText " Strikethrough", ContentControlWord NoPrefix "ulnone" SpaceSuffix, ContentControlWord NoPrefix "strike" (RTFControlParam 0), ContentControlWord NoPrefix "striked" (RTFControlParam 0), ContentText " ", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 3), ContentText " ", ContentControlSymbol '\n', ContentEscapedSequence 147, ContentEscapedSequence 250, ContentEscapedSequence 150, ContentEscapedSequence 123, ContentEscapedSequence 140, ContentEscapedSequence 234, ContentText "\n", ContentControlWord NoPrefix "f" (RTFControlParam 0), ContentText " ", ContentControlSymbol '\n', ContentControlSymbol '\n', ContentControlSymbol '\n', ContentControlWord NoPrefix "ul" SpaceSuffix, ContentText "Fonts", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 4), ContentControlWord NoPrefix "fs" (RTFControlParam 48), ContentText " ", ContentControlWord NoPrefix "ulnone" SpaceSuffix, ContentText "Aribl ", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 5), ContentText " Comic sbns\n", ContentControlWord NoPrefix "f" (RTFControlParam 0), ContentText " ", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 6), ContentText " Courier New", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 7), ContentText " Helveticb", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 0), ContentText " Helveticb Neue", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 8), ContentText " Times\n", ContentControlWord NoPrefix "f" (RTFControlParam 0), ContentText " ", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 9), ContentText " Times New Rombn", ContentControlSymbol '\n', ContentControlWord NoPrefix "f" (RTFControlParam 10), ContentText " Verdbnb\n", ContentControlWord NoPrefix "f" (RTFControlParam 0), ContentText " ", ContentControlSymbol '\n', ContentControlSymbol '\n', ContentControlSymbol '\n', ContentText "Andble Mono", ContentControlSymbol '\n', ContentText "Monbco"]
                      }
                   , ProcessResult
                      { resultMapColor =
                          [
      ...
      -- result <- applyConfig config result
      -- views _1 render (applyConfig config result)
      views _1 render result
        -- result
