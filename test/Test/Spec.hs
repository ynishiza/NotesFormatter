        ...
        it "[processDirRTF]" $ do
          ...
          formatResultForTest timestamp basePath basePath result
            `shouldBe` formatResultForTest
              ...
              , (RTFFile "/Users/yuinishizawa/Projects/NotesFormatter/test_workspace/processDirRTF/data/Info.rtf", "/Users/yuinishizawa/Projects/NotesFormatter/test_workspace/processDirRTF/bak/09292023_0656_Users_yuinishizawa_Projects_NotesFormatter_test_workspace_processDirRTF_data_Info.rtf", ProcessResult{resultMapColor = [(ColorMap{fromColor = RTFColor{red = Just 226, green = Just 226, blue = Just 226}, toColor = RTFColor{red = Just 107, green = Just 0, blue = Just 108}, toColorSpace = CSGenericRGB 41819 0 42431}, [])], resultMapText = [(TextMap{pattern = "==============================================================", replacement = "*****************************************************************************"}, 3)], resultMapFont = [(FontMap{fromFontName = "HelveticaNeue", toFontName = "Papyrus"}, [0, 1])]})
